...
<body id="page-top">
    ...
    $search = null;
    $herId = null;
    if (isset($_GET["Mai_Name"])) {
        $search = $_GET["Mai_Name"];
    }
    $sqlSearch = "SELECT * FROM maintain INNER JOIN herb_maintain ON  maintain.Mai_ID = herb_maintain.Mai_ID
    INNER JOIN herb ON herb.Her_ID = herb_maintain.Her_ID INNER JOIN herb_nature ON  herb.Her_ID = herb_nature.Her_ID
    INNER JOIN nature ON herb_nature.Nat_ID = nature.Nat_ID
    WHERE Mai_Name LIKE '%".$search."%'  ORDER BY Her_Name ASC ";
            ...
            <div class="row">
                <div class="col-lg-12 mx-auto">
                    <div class="modal-body">
                        ...
                        <h2 style="text-align:center;">สมุนไพรบำรุง : <?php echo $search; ?></h2>
                        <br>
                        <div class="row">
                          <?php
