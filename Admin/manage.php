          ...
          <div class="col-xl-11 col-lg-12 mx-auto">
            <div class="bg-faded  rounded p-5">
              <div class="list-group">
                ...
                <a href="manageHer.php">
                  <button class="list-group-item list-group-item-action">จัดสมุนไพรไทย</button>
                </a>
                <a href="manageNat.php">
                  <button class="list-group-item list-group-item-action">จัดการลักษณะ</button>
                </a>
                <a href="manageMai.php">
                  <button class="list-group-item list-group-item-action">จัดการบำรุง</button>
                </a>
                <a href="manageDis.php">
                  <button class="list-group-item list-group-item-action">จัดการโรค</button>
                </a>
              </div>
