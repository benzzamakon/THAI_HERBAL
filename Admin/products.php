...
<html lang="en">
  ...
  <body>
    ...
    <!-- กราฟแท่งแสดงสมุนไพรที่ถูกเข้าชมมากที่สุด 5 รายการต่อเดือน ต่อปี-->
          ...
          <div class="product-item-title d-flex">
            ...
            <div class="bg-faded p-5 rounded">
              <h2 class="section-heading mb-0">
                <span class="section-heading-upper">กราฟแท่งแสดงสมุนไพรที่ถูกเข้าชมมากที่สุด 5 รายการ</span>
                <span class="section-heading-lower">ต่อเดือนต่อปี</span>
              </h2>
            </div>
            </a>
          </div>
    ...
    <!-- รายงานสรุปรายชื่อโรคที่ถูกเข้าชมมากที่สุด 5 รายการต่อเดือนต่อปี -->
        ...
        <div class="product-item">
          <div class="product-item-title d-flex">
            ...
            <div class="bg-faded p-5 d-flex ml-auto rounded">
                <a  href="audience.php">
              <h2 class="section-heading mb-0">
                <span class="section-heading-upper">รายงานสรุปรายชื่อโรคที่ถูกเข้าชมมากที่สุด 5 รายการ</span>
                <span class="section-heading-lower">ต่อเดือนต่อปี</span>
              </h2>
            </a>
            </div>
