...
<body>
  ...
  <?php
     ...
     if(isset($_GET["Mai_ID"]))
     {
  	   $MaiID = $_GET["Mai_ID"];
     }

     $sql = "SELECT * FROM maintain WHERE Mai_ID = '".$MaiID."' ";
  ...
  ?>
<form class="manage" id="edifdate" name="edifdate" method="post" action="php/saveMai.php" enctype="multipart/form-data">
          ...
          <div class="col-xl-9 col-lg-12 mx-auto">
            <div class="bg-faded  rounded p-5">
              <h2 class="section-heading mb-4">
                <span class="section-heading-lower">แก้ไขข้อมูลบำรุง</span>
              </h2>
              <div class="row ">
                <div class="col-sm-3">
                  <p>รหัสบำรุง</p>
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="hidden" name="txtMaiID" value="<?php echo $result["Mai_ID"];?>"/><?php echo $result["Mai_ID"];?>
                </div>
                <div class="col-sm-3">
                  <p>บำรุง</p>
                </div>
                <div class="col-sm-10">
                  <input class="form-control" name="txtMaiName"  value="<?php echo $result["Mai_Name"];?>" required="required" placeholder="<?php echo $result["Mai_Name"];?>" />
                </div>
                <!-- บันทึก -->
