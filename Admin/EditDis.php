...
<body>
  ...
  ?>
<form class="manage" id="edifdate" name="edifdate" method="post" action="php/saveDis.php" enctype="multipart/form-data">
          ...
          <div class="col-xl-9 col-lg-12 mx-auto">
            <div class="bg-faded  rounded p-5">
              <h2 class="section-heading mb-4">
                <span class="section-heading-lower">แก้ไขข้อมูลโรค</span>
              </h2>
              <div class="row ">
                <div class="col-sm-3">
                  <p>รหัสโรค</p>
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="hidden" name="txtDisID" id="txtDisID" value="<?php echo $result["Dis_ID"];?>"><?php echo $result["Dis_ID"];?>
                </div>
                ...
                <div class="col-sm-10">
                  <input class="form-control" name="txtDisName" id="txtDisName" value="<?php echo $result["Dis_Name"];?>"  />
                </div>
                <div class="col-sm-2">
                  <p>อาการ</p>
                </div>
                <div class="col-sm-10">
                  <textarea class="form-control" name="txtDisSym" id="txtDisSym" value="<?php echo $result["Dis_symptom"];?>" placeholder="<?php echo $result["Dis_symptom"];?>" rows="6"></textarea>
                </div>
