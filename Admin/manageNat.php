...
<body>
  ...
  <form class="manage" id="manage" name="manage" method="post" action="php/manageBackNat.php" enctype="multipart/form-data">
          ...
          <div class="col-xl-9 col-lg-12 mx-auto">
            <div class="bg-faded  rounded p-5">
              <h2 class="section-heading mb-4">
                <span class="section-heading-lower">จัดการลักษณะ</span>
              </h2>
              <div class="row ">
                <br>
                <br>
                <div class="col-sm-2">
                  <p size="18px">ลักษณะ</p>
                </div>
                <div class="col-sm-10">
                  <input class="form-control" name="natName" id="natName" value="" required="required" placeholder="ชื่อโรค" />
                </div>
        ...
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-4">
                <span class="section-heading-upper">ชื่อลักษณะ</span>
                <span class="section-heading-lower">ทั้งหมด</span>

              </h2>
              <div class="table-responsive">
                  <tbody>
                    <iframe src="php/iframeNat.php" width="500px" height="320px">
