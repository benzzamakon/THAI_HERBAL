...
<body>
  ...
  <form class="manage" id="manage" name="manage" method="post" action="php/manageBackMai.php" enctype="multipart/form-data">
          ...
          <div class="col-xl-9 col-lg-12 mx-auto">
            <div class="bg-faded  rounded p-5">
              <h2 class="section-heading mb-4">
                <span class="section-heading-lower">จัดการบำรุง</span>
              </h2>
              <div class="row ">
                <br>
                <br>
                ...
                <div class="col-sm-10">
                  <input class="form-control" name="maiName" value="" required="required" placeholder="ชื่อบำรุง" />
                </div>
                <!-- บันทึก -->
        ...
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-4">
                <span class="section-heading-upper">ชื่อบำรุง</span>
                <span class="section-heading-lower">ทั้งหมด</span>

              </h2>
              <div class="table-responsive">
                  <tbody>
                    <iframe src="php/iframeMai.php" width="500px" height="320px">
